...
namespace AllNotes.Views.NewNote.Popups
{
    ...
    public partial class ColorPickerPopup2 : Popup
    {
        ...
        public ColorPickerPopup2(WebView webViewRte) : this() // Call the default constructor
        {
            _webViewRte = webViewRte;
            BindingContext = new ColorPickerViewModel();
            // Additional initialization with WebView if necessary
        }
        public ColorPickerPopup2()
        {
            InitializeComponent();
        ...
        {
            _webViewRte?.EvaluateJavaScriptAsync("setBackgroundColor('#FF0000')");
        }
        ...
        {
            ExecuteJavaScript("setBackgroundColor('#00FF00')");
        }

        public void OnSetTextColorBlueClicked(object sender, EventArgs e)
        {
            ExecuteJavaScript("setBackgroundColor('#0000FF')");
        }
        ...
        private void OnColorButtonClicked(object sender, EventArgs e)
        {
            if (sender is Button button && _webViewRte != null)
            {
                ...
                var script = $"setBackgroundColor('{color}')";
                _webViewRte.EvaluateJavaScriptAsync(script);
            }
        }
        private void OnRedButtonClicked(object sender, EventArgs e)
        ...
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#00FF00')");
            this.Dismiss(null);
        }

        private void OnBlueButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#0000FF')");
            this.Dismiss(null);
        }
        private void OnYellowButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#FFFF00')");
            this.Dismiss(null);
        }

        private void OnPurpleButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#800080')");
            this.Dismiss(null);
        }

        private void OnOrangeButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#FFA500')");
            this.Dismiss(null);
        }

        private void OnBlackButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#000000')");
            this.Dismiss(null);
        }

        private void OnWhiteButtonClicked(object sender, EventArgs e)
        {
            _webViewRte.EvaluateJavaScriptAsync("setBackgroundColor('#FFFFFF')");
            this.Dismiss(null);
        }
